...
public class WorldContactListener implements ContactListener {
    ...
    public void beginContact(Contact contact) {
        ...
        switch (catDef) {
            ...
            case FinalStand.BOT_BOUND_BIT | FinalStand.BARRICADE_BIT:
            case FinalStand.BOT_BOUND_BIT | FinalStand.GLUE_BIT:
            case FinalStand.BOT_BOUND_BIT | FinalStand.BOMB_BIT:
            case FinalStand.BOT_BOUND_BIT | FinalStand.SPIKE_BIT:
            case FinalStand.RIGHT_BOUND_BIT | FinalStand.BARRICADE_BIT:
            case FinalStand.RIGHT_BOUND_BIT | FinalStand.GLUE_BIT:
            case FinalStand.RIGHT_BOUND_BIT | FinalStand.BOMB_BIT:
            case FinalStand.RIGHT_BOUND_BIT | FinalStand.SPIKE_BIT:
            case FinalStand.LEFT_BOUND_BIT | FinalStand.BARRICADE_BIT:
            case FinalStand.LEFT_BOUND_BIT | FinalStand.GLUE_BIT:
            case FinalStand.LEFT_BOUND_BIT | FinalStand.BOMB_BIT:
            case FinalStand.LEFT_BOUND_BIT | FinalStand.SPIKE_BIT:
            case FinalStand.TOP_BOUND_BIT | FinalStand.BARRICADE_BIT:
            case FinalStand.TOP_BOUND_BIT | FinalStand.GLUE_BIT:
            case FinalStand.TOP_BOUND_BIT | FinalStand.BOMB_BIT:
            case FinalStand.TOP_BOUND_BIT | FinalStand.SPIKE_BIT: {
                if(fixA.getFilterData().categoryBits == FinalStand.BOT_BOUND_BIT) {
                    ((Trap) fixB.getUserData()).onCreepHit((Creep) fixA.getUserData());
                } else {
                    ((Trap) fixA.getUserData()).onCreepHit((Creep) fixB.getUserData());
                }
            } break;
        }
...
//        }
    ...
    public void endContact(Contact contact) {
        ...
        switch (catDef) {
            ...
            case FinalStand.TOP_BOUND_BIT | FinalStand.SPIKE_BIT:{
                if(fixA.getFilterData().categoryBits == FinalStand.BOT_BOUND_BIT) {
                    ((Trap) fixB.getUserData()).onCreepRelease((Creep) fixA.getUserData());
                } else {
                    ((Trap) fixA.getUserData()).onCreepRelease((Creep) fixB.getUserData());
                }
            } break;
        }
    }
